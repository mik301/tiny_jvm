...
public class BuiltinObject {
    ...
    static {
        ...
        s("uicc/access/UICCException", "javacard/framework/CardRuntimeException");
        s("uicc/toolkit/ToolkitException", "javacard/framework/CardRuntimeException");
        s("uicc/access/FileView", "java/lang/Object");
        s("uicc/access/UICCSystem", "java/lang/Object");
        s("uicc/toolkit/ToolkitRegistry", "java/lang/Object");
        s("uicc/toolkit/ToolkitRegistrySystem", "java/lang/Object");
        s("uicc/toolkit/EnvelopeHandler", "java/lang/Object");
        s("uicc/toolkit/EnvelopeHandlerSystem", "java/lang/Object");
        s("uicc/toolkit/ProactiveHandler", "java/lang/Object");
        s("uicc/toolkit/ProactiveHandlerSystem", "java/lang/Object");
        s("uicc/toolkit/ProactiveResponseHandler", "java/lang/Object");
        s("uicc/toolkit/ProactiveResponseHandlerSystem", "java/lang/Object");

        s("sim/access/SIMViewException", "javacard/framework/CardRuntimeException");
        s("sim/toolkit/ToolkitException", "javacard/framework/CardRuntimeException");
        s("sim/access/SIMView", "java/lang/Object");
        s("sim/access/SIMSystem", "java/lang/Object");
        s("sim/toolkit/ToolkitRegistry", "java/lang/Object");
        s("sim/toolkit/ToolkitRegistrySystem", "java/lang/Object");
        s("sim/toolkit/EnvelopeHandler", "java/lang/Object");
        s("sim/toolkit/EnvelopeHandlerSystem", "java/lang/Object");
        s("sim/toolkit/EnvelopeResponseHandler", "java/lang/Object");
        s("sim/toolkit/ProactiveHandler", "java/lang/Object");
        s("sim/toolkit/ProactiveHandlerSystem", "java/lang/Object");
        s("sim/toolkit/ProactiveResponseHandler", "java/lang/Object");
    }
